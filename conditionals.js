...
function exercise1(num1) {
  ...
  console.log(exercise6(1,1,0)); //ture
  console.log(exercise6(0,1,0)); //false
  console.log(exercise6(0,1,1)); //false
  ...
  console.log(exercise8(1,3,1,10));
  console.log(exercise8(8,30,7,10));
  console.log(exercise8(2,3,1,10));
  console.log(exercise8(-2,3,1,10));
