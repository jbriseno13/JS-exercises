...
// Exercise 7. Read the following code (don't run it yet)
  ...
  // Without running the code, write down in a comment:
  // 1. mysteryFunction2 is returning the value of x which is p1-p2.
  ...
  // Some of the questions were a bit more challenging than others. Overall the assignment was fairly easy to complete.
